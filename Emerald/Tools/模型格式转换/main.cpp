...
{
	float3 *vertices, *texcoords, *normals;
	FaceType *faces;
	ifstream fin;
	...
	texcoords = new float3[textureCount];
	if(!texcoords)
	{
		return false;
	}
	...
	while(!fin.eof())
	{
		...
		if(input == 'f')
		{
			...
			if(input == ' ')
			{
				...
				if(input == ' ')
				{
					faces[faceIndex].vIndex1 = faces[faceIndex-1].vIndex2;
					faces[faceIndex].tIndex1 = faces[faceIndex-1].tIndex2;
					faces[faceIndex].nIndex1 = faces[faceIndex-1].nIndex2;
					faces[faceIndex].vIndex2 = faces[faceIndex-1].vIndex1;
					faces[faceIndex].tIndex2 = faces[faceIndex-1].tIndex1;
					faces[faceIndex].nIndex2 = faces[faceIndex-1].nIndex1;
